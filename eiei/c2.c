// Part 3.2 - Initial test with 10x8 array
#include <stdio.h>
#include <stdlib.h>
#include <time.h>
...
int main()
{
    ...
    r1 = sum_array_specify_quadrant_method1(ptr, 0);
    r2 = sum_array_specify_quadrant_method1(ptr, 1);
    r3 = sum_array_specify_quadrant_method1(ptr, 2);
    r4 = sum_array_specify_quadrant_method1(ptr, 3);
