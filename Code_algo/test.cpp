...
int main()
{
    ...
    cin>>t;
    if(t==1 || t==3){
        cout<<"I'll need to wake up early tomorrow.";
    }
    else if(t==4 || t==6){
        cout<<"I'm feeling unwell, I need to leave.";
    }
    else if(t==7 || t==9){
        cout<<"I forgot I have an important meeting soon.";
    }
    else if(t==10){
        cout<<"Sorry, but I think this isn't working out.";
    }
